## Statement
The [[Domain of a Relation]] $R$, $\textnormal{dom}\\, R$, is a set.
...
But this set is exactly those elements in $\textnormal{dom}\, R$, and hence by the [[Axiom of Extensionality]] the two are equal.\
Hence $\textnormal{dom}\\, R$ is a set, as wanted.
